...
{!! Form::open(['url' => '/new-manufacturer', 'class' => 'form-horizontal']) !!}
...
<div class="form-group">
    ...
    <div class="col-md-6">
        <textarea id="mytextarea" name="manufacturerDescription" class="form-control"></textarea>
...
<div class="form-group">
    ...
    <div class="col-md-offset-2 col-md-6">
        <input type="submit" class="btn btn-success btn-block" value="Save Manufacturer Info">
    </div>
