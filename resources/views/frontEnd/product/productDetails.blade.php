...
<div class="single">
    <div class="container">
        <div class="col-md-6 single-right-left animated wow slideInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInUp;">
            <div class="grid {{asset($productDetails->productImage)}}">
        ...
        <div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInRight;">
            ...
            <p><span class="item_price">TK. {{$productDetails->productPrice}}</span>
                <!--<del>- $900</del></p>-->
            <div class="rating1">
            ...
            <div class="color-quality">
                <div class="color-quality-right">
                    ...
                    <input type="number" value="1" min="1" class="form-control" name="qty">
                            <input type="hidden" value="{{$productDetails->id}}" class="form-control" name="productId">
            ...
            <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                ...
                <div id="myTabContent" class="tab-content">
                    <div role="tabpanel" class="tab-pane fade in active bootstrap-tab-text" id="home" aria-labelledby="home-tab">
                        ...
                        <p> {{$productDetails->productShortDescription}}</p>
                        <hr>
                        <p> {{$productDetails->productLongDescription}}</p>
                    </div>
